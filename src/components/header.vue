  ...
  <div class="header" :class="[{ fixedToTop }, themeColor]">
    <ul class="navbar">
      ...
      <router-link exact to="/jobs" v-slot="{ href, navigate, isActive }">
        <li class="navbar-item" :class="{ active: isActive }">
          <a :href="href" @click="navigate">燕麦纤维</a>
        </li>
      </router-link>
      <router-link to="/products" v-slot="{ href, navigate, isActive }">
        <li class="navbar-item" :class="{ active: isActive }">
          <a :href="href" @click="navigate">每日食谱</a>
        </li>
      </router-link>
      <li class="navbar-item">
        <a href="/health" target="_blank">健康饮食</a>
      </li>
    </ul>|
    <div class="user">
      ...
      <div class="dropdown-menu" v-else>
        ...
        <ul class="dropdown-menu__wrapper">
          <li class="dropdown-menu__item">
            <router-link to="/resume">膳食纤维与肠道菌群</router-link>
          </li>
          <li class="dropdown-menu__item" @click="handleLogout">人体微生态的保护</li>
        </ul>
      </div>
    </div>
  </div>
